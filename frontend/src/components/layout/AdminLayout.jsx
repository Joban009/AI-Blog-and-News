    ...
    <div className="min-h-screen flex bg-ink-50">
      ...
      <aside className="w-60 shrink-0 bg-white border-r border-ink-100 flex flex-col">
        <div className="h-16 flex items-center px-5 border-b border-ink-100">
          <Link to="/" className="font-serif text-lg font-bold text-ink-900">
            AI<span className="text-amber-500">News</span>Blog
          </Link>
          <span className="ml-2 badge badge-amber text-[10px]">Admin</span>
        </div>
        ...
        <nav className="flex-1 p-3 flex flex-col gap-1">
          ...
          <div className="mt-2 pt-2 border-t border-ink-100">
            <NavLink to="/admin/posts/new" className={link}>
              <PenSquare size={17} />
              New Post
            </NavLink>
            <Link to="/" target="_blank" className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium font-sans text-ink-600 hover:bg-ink-50 hover:text-ink-900 transition-colors">
        ...
        <div className="p-3 border-t border-ink-100">
          ...
          <button onClick={logout}
            className="mt-1 w-full flex items-center gap-3 px-3 py-2 rounded-xl text-sm font-sans text-red-500 hover:bg-red-50 transition-colors">
