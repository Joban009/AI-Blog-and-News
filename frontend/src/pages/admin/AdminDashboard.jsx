...
import {
  FileText, MessageSquare, Users, Eye,
    ...
    <div className="space-y-8">
      ...
      <div className="card">
            ...
            <div key={p.id} className="px-5 py-3.5 flex items-center justify-between gap-4">
              <div className="min-w-0">
                ...
                <p className="text-xs text-ink-400 font-sans mt-0.5">
                  by {p.author} · {formatDistanceToNow(new Date(p.created_at), { addSuffix: true })}
                </p>
              </div>
        ...
        <div className="px-5 py-3 border-t border-ink-100">
          <Link to="/admin/posts" className="text-xs text-amber-600 hover:text-amber-700 font-sans font-medium">
            View all posts →
          </Link>
        </div>
      </div>
