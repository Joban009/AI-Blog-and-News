          ...
          <div key={c.id} className="p-4 flex gap-4">
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap items-center gap-2 mb-2">
                <span className="font-sans text-sm font-semibold text-ink-900">{c.author}</span>
              ...
              {/* Post link */}
              <Link to={`/posts/${c.post_slug}`} className="text-xs text-amber-600 hover:text-amber-700 font-sans">
                On: {c.post_title}
              </Link>
            </div>
