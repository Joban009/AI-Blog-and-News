...
export default function SubmitPostPage() {
  ...
  const [form, setForm] = useState({
    ...
    cover_image_url: '', type: 'blog', tags: '',
  });
    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="flex gap-3">
          {['blog', 'news'].map(t => (
            <label key={t} className={`flex items-center gap-2 px-4 py-2.5 rounded-xl border cursor-pointer transition-colors font-sans text-sm capitalize
        ...
        {/* Excerpt */}
        <div>
          <label className="block text-xs font-sans font-medium text-ink-700 mb-1.5">Excerpt / Summary</label>
